# JARVIS Future Update Roadmap

This document outlines future features and capabilities we plan to add to JARVIS to make it a more powerful local AI assistant.
...
*Note: As we implement these features, we will check them off and add new ideas here.*
